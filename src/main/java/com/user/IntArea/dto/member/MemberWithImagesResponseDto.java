...
import com.user.IntArea.dto.image.ImageDto; // ImageDto를 가져오기
...
@Data
@NoArgsConstructor
public class MemberWithImagesResponseDto {
    ...
    private List<ImageDto> images; // ImageDto 리스트로 변경

    public MemberWithImagesResponseDto(Member member, List<ImageDto> images) {
        ...
        this.images = images; // ImageDto 리스트 초기화
    }
}
