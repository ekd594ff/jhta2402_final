...
function PortfolioListItem(props) {
    const {avgrate, title, thumbnail, companyname, description, portfolioid} = props;
    return <li className={style['portfolio-list-item']}>
        <div className={style['top']}>
            <img className={style['thumbnail']} src={thumbnail || `https://picsum.photos/seed/${Date.now()}/1200/800`}
